    ...
    return (
        <div className="p-4 space-y-6">
            <div className="flex items-center justify-between">
                <h2 className="text-2xl text-gray-600 font-bold">Simulation: {scenario.name}</h2>
                <Button
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="border rounded-lg p-4">
                    <h2 className="text-lg font-semibold mb-3">Visualisation du workflow</h2>
                    <div className="h-96">
                        <FlowChart logs={logs} scenario={scenario} />
                    </div>
                </div>
            </div>
        </div>
